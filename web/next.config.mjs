  ...
  async rewrites() {
    ...
    return [
      ...
      },
      {
        ...
        destination: `${backend}/api/v1/admin/:path*`,
      },
      ...
      // Use a separate rewrite for non-AI paths
      {
        ...
        destination: `${backend}/api/v1/questions/:path*`,
      },
      ...
      // Rewrites buffer SSE, so only the base list endpoint stays here.
      {
        ...
        destination: `${backend}/api/v1/resumes`,
      },
      {
        source: "/api/v1/study/:path*",
        destination: `${backend}/api/v1/study/:path*`,
      },
      {
        source: "/api/v1/knowledge/:path*",
        destination: `${backend}/api/v1/knowledge/:path*`,
      },
      {
        source: "/api/v1/health",
        destination: `${backend}/api/v1/health`,
      },
      {
        source: "/api/v1/tasks/:path*",
        destination: `${backend}/api/v1/tasks/:path*`,
      },
